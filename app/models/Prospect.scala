...
/**
  ...
  */
case class Prospect(_id: String, firstName: String, lastName: String, documentType: String, documentId: String, birthDate: String, entryDate: String, exitDate: String, institution: Institution, institutionCode: String, title: String, nacionNews: List[News], infobaeNews: List[News], clarinNews: List[News], cronistaNews: List[News], linkedInProfiles: List[LinkedinUserProfile], country: String, primaryEmail: String, secondaryEmail: String, createdAt: String, updatedAt: String, errorDate: String) {
